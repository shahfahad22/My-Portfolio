  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Bootstrap", level: 75, color: "from-purple-500 to-pink-500" },
      ]
    },
    {
      ...
      skills: [
        ...
        { name: "Express.js", level: 80, color: "from-gray-500 to-gray-400" },
        { name: "MongoDB", level: 78, color: "from-green-600 to-green-700" },
        { name: "REST APIs", level: 78, color: "from-indigo-500 to-purple-500" },
        { name: "JWT Authentication", level: 70, color: "from-yellow-500 to-orange-500" },
        { name: "Socket.io", level: 65, color: "from-blue-500 to-blue-600" },
      ]
    },
    {
      category: "Tools & Technologies",
      ...
      skills: [
        ...
        { name: "npm/yarn", level: 80, color: "from-red-500 to-red-600" },
      ]
    }
  ]
        ...
        >
          {skillCategories.map((category, categoryIndex) => (
            <motion.div
              key={category.category}
              variants={itemVariants}
              className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700 hover:border-blue-400/30 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300"
            >
              {/* Category Header */}
              ...
              <div className="w-12 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 mb-6"></div>
              ...
              <div className="space-y-5">
                {category.skills.map((skill, skillIndex) => (
                  <motion.div
                    ...
                    initial={{ opacity: 0, x: -20 }}
                    animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -20 }}
                    transition={{ delay: (categoryIndex * 0.2) + (skillIndex * 0.08) }}
                    className="group"
                  >
                    {/* Skill Row */}
